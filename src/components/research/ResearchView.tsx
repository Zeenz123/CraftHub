...
export const ResearchView: React.FC = () => {
  ...
  const discoveryCards = [
    {
      ...
      researchers: [
        { name: 'Dr. Srinivas Iyer', role: 'Principal Investigator', avatar: '/assets/images/tech_ai_03.jpg' },
        { name: 'Zaman', role: 'Lead Design Engineer', avatar: currentUser.avatar },
        { name: 'Pooja Nair', role: 'Solid State Fellow', avatar: '/assets/images/tech_circuit_01.jpg' }
      ],
    ...
    },
    {
      ...
      researchers: [
        { name: 'Prof. Ramesh Kulkarni', role: 'Lead Director', avatar: '/assets/images/tech_robotics_02.jpg' },
        { name: 'Zaman', role: 'Perception Specialist', avatar: currentUser.avatar },
        { name: 'Kavita Menon', role: 'Control Systems', avatar: '/assets/images/tech_robotics_03.jpg' }
      ],
    ...
    },
    {
      ...
      researchers: [
        { name: 'Dr. Ananya Roy', role: 'Materials Scientist', avatar: '/assets/images/tech_energy_01.jpg' },
        { name: 'Rahul Chhabra', role: 'Electrochemistry Fellow', avatar: '/assets/images/tech_energy_03.jpg' }
      ],
    ...
    },
    {
      ...
      researchers: [
        { name: 'Dr. Tarun Verma', role: 'Clinical Neuro-Engineer', avatar: '/assets/images/tech_biotech_01.jpg' },
        { name: 'Meera Deshmukh', role: 'Firmware Engineer', avatar: '/assets/images/tech_biotech_02.jpg' }
      ],
    ...
    {
      id: 'res-disc-5',
      title: 'Sub-Kelvin Superconducting Transmon Qubit Control Hardware',
      category: 'Physics',
      organization: 'TIFR / IISc Quantum Computing National Mission',
      image: '/assets/images/card_quantum_computing.jpg',
      progress: 58,
      stage: 'Phase 3: 16-Qubit Coherence',
      researchers: [
        { name: 'Dr. Srinivas Rao', role: 'Quantum Lead', avatar: '/assets/images/tech_lab_02.jpg' },
        { name: 'Aditi Sharma', role: 'Cryogenic RF Fellow', avatar: '/assets/images/tech_lab_03.jpg' }
      ],
      location: 'Bengaluru, Karnataka',
      skills: ['Cryogenics 10mK', 'Microwave Control', 'Qiskit Metal', 'Josephson Junctions'],
      grant: 'National Quantum Mission (₹18 Cr)',
      projectId: 'proj-10'
    },
    {
      id: 'res-disc-6',
      title: 'CRISPR Cas13 Microfluidic Point-of-Care Diagnostic Biochip',
      category: 'Biotechnology',
      organization: 'C-CAMP & National Center for Biological Sciences (NCBS)',
      image: '/assets/images/card_biotech_crispr.jpg',
      progress: 74,
      stage: 'Phase 4: Field Pathogen Trials',
      researchers: [
        { name: 'Dr. Neha Varma', role: 'Genomics Lead', avatar: '/assets/images/tech_biotech_03.jpg' },
        { name: 'Arun Kulkarni', role: 'Microfluidics Engineer', avatar: '/assets/images/tech_biotech_04.jpg' }
      ],
      location: 'Bengaluru, Karnataka',
      skills: ['Cas13 Ribonuclease', 'Droplet Microfluidics', 'Fluorescence Sensing', 'PDMS'],
      grant: 'DBT Biotechnology Apex Grant',
      projectId: 'proj-12'
    },
    {
      id: 'res-disc-7',
      title: 'Hyperspectral Optical Laser Communication for Swarm CubeSats',
      category: 'Space',
      organization: 'IN-SPACe & IIT Madras Aerospace Innovation Center',
      image: '/assets/images/card_satellite_project.jpg',
      progress: 81,
      stage: 'Phase 5: Environmental Thermal-Vacuum Test',
      researchers: [
        { name: 'Rohan Joshi', role: 'Avionics Lead', avatar: '/assets/images/tech_space_01.jpg' },
        { name: 'Priya Nambiar', role: 'Orbital Mechanics Specialist', avatar: '/assets/images/tech_space_02.jpg' }
      ],
      location: 'Hyderabad, Telangana',
      skills: ['Laser Downlink', 'Radiation Hardening', 'Reaction Wheels', 'Orbital Propellant'],
      grant: 'ISRO RESPOND Program Funded',
      projectId: 'proj-13'
    },
    {
      id: 'res-disc-8',
      title: 'Multi-Spectral IoT Sub-Surface Agronomic Telemetry Mesh',
      category: 'Energy',
      organization: 'Punjab Agricultural University & IIT Ropar AgriTech Hub',
      image: '/assets/images/card_smart_agriculture.jpg',
      progress: 88,
      stage: 'Phase 5: Multi-District Farm Deployment',
      researchers: [
        { name: 'Dr. Gurpreet Singh', role: 'AgriTech Director', avatar: '/assets/images/tech_education_02.jpg' },
        { name: 'Simran Kaur', role: 'Embedded Telemetry', avatar: '/assets/images/tech_circuit_02.jpg' }
      ],
      location: 'Ludhiana, Punjab',
      skills: ['LoRaWAN 865MHz', 'NPK Capacitive Sensing', 'Solar Energy Harvesting', 'TinyML'],
      grant: 'ICAR Agritech Innovation Fund',
      projectId: 'proj-03'
    }
  ];
  ...
  const activeSpotlight = {
    ...
    researchers: [
      ...
      { name: 'Dr. Vikram Sethi', role: 'Advisor (IIT Delhi)', avatar: '/assets/images/tech_education_01.jpg' },
      { name: 'Ayesha Siddiqui', role: 'Computer Vision', avatar: '/assets/images/tech_ai_04.jpg' }
    ],
    requiredEquipment: [
  ...
  const infrastructureItems = [
    ...
    },
    {
      ...
      type: 'Equipment',
      image: '/assets/images/tech_lab_07.jpg',
    ...
    },
    {
      ...
      type: 'Universities',
      image: '/assets/images/tech_manufacturing_06.jpg',
    ...
    },
    {
      ...
      image: '/assets/images/tech_biotech_05.jpg',
  ...
  const activityItems = [
    {
      ...
      thumbnail: '/assets/images/tech_robotics_05.jpg'
    },
    {
      id: 'act-2',
      type: 'experiment',
      ...
      thumbnail: '/assets/images/card_cleanroom_nanofab.jpg'
    },
    {
      id: 'act-3',
      type: 'contributor',
      ...
      thumbnail: '/assets/images/tech_ai_05.jpg'
    },
    {
      id: 'act-4',
      type: 'milestone',
      ...
      thumbnail: '/assets/images/card_wearable_biosensor.jpg'
    }
  ];
  ...
  return (
    <div id="research-ecosystem-page" className="min-h-screen bg-[#040817] text-slate-100 font-sans selection:bg-cyan-500 selection:text-black">
      ...
      <div className="relative overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[#040817]/95 via-[#040817]/70 to-transparent" />
        <div className="absolute inset-0 flex flex-col justify-center px-8">
          <p className="text-[10px] text-cyan-400 font-bold uppercase tracking-widest mb-1">RESEARCH</p>
          <h1 className="text-3xl sm:text-4xl font-extrabold text-white leading-tight uppercase">
            DISCOVER.<br />
            <span className="text-[#00d2ff]">EXPERIMENT. PUBLISH.</span>
          </h1>
          <p className="text-xs text-slate-300 mt-2 max-w-lg">
            Peer-reviewed deep-tech & academic science. Join cutting-edge research across AI, nanotechnology, robotics and more.
          </p>
        </div>
      </div>
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-5 relative">
              ...
              <div className="relative rounded-2xl overflow-hidden border border-[#234ca1] bg-[#070e24] shadow-2xl group">
                <img 
                  src="/assets/images/card_cleanroom_nanofab.jpg" 
