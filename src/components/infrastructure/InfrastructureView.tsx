...
export const InfrastructureView: React.FC = () => {
  ...
  const popularEquipment = [
    { name: '3D Printer', model: 'Prusa i3 MK4', status: 'Available', type: 'Additive' },
    { name: 'Laser Cutter', model: 'Glowforge Pro', status: 'Available', type: 'Fabrication' },
    { name: 'Robotic Arm', model: 'UR5 Industrial', status: 'Available', type: 'Robotics' },
    { name: 'CNC Machine', model: 'Tormach 1100M', status: 'Available', type: 'Subtractive' },
  ];

  return (
    <div id="infrastructure-view" className="p-6 space-y-6 max-w-[1440px] mx-auto font-sans text-slate-100 select-none">
          ...
          <div className="bg-[#071333] border border-[#162c5e] rounded-2xl p-5 space-y-3">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {popularEquipment.map((eq) => (
                <div key={eq.name} className="p-3 rounded-xl bg-[#09173d] border border-[#18346e] space-y-1">
                  <div className="font-bold text-xs text-white">{eq.name}</div>
                  <div className="text-[10px] text-slate-400">{eq.model}</div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-[#071333] border border-[#162c5e] rounded-2xl p-5 space-y-3.5">
            ...
            <div className="space-y-2.5">
              {[
                { title: 'Robotics Lab', inst: 'IIT Delhi', date: 'Apr 12' },
                { title: '3D Printing Room', inst: 'NIT Trichy', date: 'Apr 15' },
                { title: 'Electronics Lab', inst: 'IIIT Hyderabad', date: 'Apr 18' },
              ].map((b) => (
                <div key={b.title} className="p-3 rounded-xl bg-[#09173d] border border-[#18346e] flex items-center justify-between text-xs">
                  <div>
