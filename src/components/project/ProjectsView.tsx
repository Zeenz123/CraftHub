...
export const ProjectsView: React.FC = () => {
  ...
  const allProjects: ProjectCardItem[] = [
    ...
    },
    {
      ...
      category: 'Research',
      description: 'Sub-Kelvin superconducting transmon qubit control hardware and high-precision FPGA microwave pulse synthesis.',
      image: '/assets/images/card_quantum_computing.jpg',
      status: 'Research',
      progress: 55,
      tags: ['Quantum', 'DeepTech', 'Cryogenics', 'FPGA'],
      contributors: 10,
      comments: 24,
      likes: 76,
      location: 'Bengaluru, India'
    },
    {
      ...
      category: 'CleanTech',
      description: 'Open-architecture steer-by-wire electric vehicle platform with regenerative braking and CAN-FD autonomous telemetry.',
      image: '/assets/images/card_autonomous_ev.jpg',
      status: 'Active',
      progress: 78,
      tags: ['CleanTech', 'EV Mobility', 'CAN-Bus', 'Automotive'],
      contributors: 14,
      comments: 36,
      likes: 110,
      location: 'Pune, India'
    },
    {
      ...
      category: 'Research',
      description: 'Automated benchtop microfluidic biochip for targeted genomic Cas13 ribonucleoprotein synthesis and point-of-care assays.',
      image: '/assets/images/card_biotech_crispr.jpg',
      status: 'Seeking Contributors',
      progress: 38,
      tags: ['BioTech', 'CRISPR', 'Microfluidics', 'Genomics'],
      contributors: 6,
      comments: 14,
      likes: 58,
      location: 'Bengaluru, India'
    },
    {
      ...
      category: 'Hardware',
      description: 'Radiation-hardened power conditioning and inter-satellite optical laser communication terminal for 1U nanosatellites.',
      image: '/assets/images/card_satellite_project.jpg',
      status: 'Active',
      progress: 82,
      tags: ['SpaceTech', 'Aerospace', 'OpticalComms', 'CubeSats'],
      contributors: 16,
      comments: 42,
      likes: 124,
      location: 'Hyderabad, India'
    ...
    {
      id: 'proj-cleanroom',
      title: 'Sub-10nm E-Beam Cleanroom Stage',
      category: 'Hardware',
      description: 'Laser interferometer-guided piezo positioning stage designed for ultra-high-resolution electron beam lithography.',
      image: '/assets/images/card_cleanroom_nanofab.jpg',
      status: 'Open',
      progress: 68,
      tags: ['Nanofab', 'Cleanroom', 'Semiconductor', 'Piezo'],
      contributors: 8,
      comments: 19,
      likes: 62,
      location: 'Bengaluru, India'
    },
    {
      ...
      category: 'Electronics',
      description: 'Custom RISC-V tensor core taped out in 28nm for low-power spiking neural network robotic vision.',
      image: '/assets/images/card_ai_neural_processor.jpg',
      status: 'Active',
      progress: 70,
      tags: ['VLSI', 'RISC-V', 'EdgeAI', 'Silicon'],
      contributors: 11,
      comments: 28,
      likes: 95,
      location: 'Chennai, India'
    ...
    {
      id: 'proj-biosensor',
      title: 'Continuous Epidermal Biosensor Patch',
      category: 'Hardware',
      description: 'Flexible biocompatible skin patch with wireless BLE 5.3 telemetry monitoring real-time lactate, hydration, and glucose.',
      image: '/assets/images/card_wearable_biosensor.jpg',
      status: 'Seeking Contributors',
      progress: 52,
      tags: ['MedTech', 'Wearables', 'BioSensors', 'BLE'],
      contributors: 7,
      comments: 17,
      likes: 54,
      location: 'Mumbai, India'
    ...
    {
      id: 'proj-mfg',
      title: '5-Axis Smart Robotic CNC Machining Cell',
      category: 'Manufacturing',
      description: 'Automated workpiece loading and in-process visual tool-wear compensation on high-speed 5-axis milling machines.',
      image: '/assets/images/card_manufacturing_intern.jpg',
      status: 'Active',
      progress: 64,
      tags: ['Manufacturing', 'CNC', 'Robotics', 'Automation'],
      contributors: 9,
      comments: 23,
      likes: 71,
      location: 'Pune, India'
  ...
  return (
    <div id="projects-view" className="font-sans text-slate-100 select-none">
      {/* Hero Banner Image */}
      <div className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col justify-center px-8">
          <p className="text-[10px] text-cyan-400 font-bold uppercase tracking-widest mb-1">PROJECTS</p>
          <h1 className="text-3xl sm:text-4xl font-extrabold text-white leading-tight uppercase">
            BUILD REAL THINGS.<br />
            <span className="text-[#00d2ff]">CREATE REAL IMPACT.</span>
          </h1>
          <p className="text-xs text-slate-300 mt-2 max-w-md">
            Discover, manage, join, or launch engineering builds. Collaborate with makers, researchers and innovators.
          </p>
        </div>
      </div>
