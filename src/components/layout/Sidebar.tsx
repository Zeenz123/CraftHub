...
export const Sidebar: React.FC = () => {
  ...
  const SidebarContent = () => (
    <aside 
      id="main-sidebar" 
      className="w-60 bg-[#050a1d]/98 backdrop-blur-xl border-r border-[#152a5c] shadow-[4px_0_30px_rgba(0,0,0,0.5)] flex flex-col h-full select-none transition-all font-sans"
    >
      {/* Brand Header */}
      <div className="p-4 border-b border-[#152754] flex items-center justify-between">
        <button 
        ...
        <button
          ...
          className="lg:hidden p-1.5 rounded-lg text-slate-400 hover:text-white hover:bg-[#0b1636] transition-colors"
        >
          <X className="w-4 h-4" />
        </button>
      </div>
  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-3.5 left-3.5 z-50 p-2 rounded-xl bg-[#09132e] border border-[#1a3473] text-slate-300 hover:text-white hover:border-[#2550b0] transition-colors shadow-lg"
