...
export const Header: React.FC = () => {
  ...
  return (
    <header 
      id="main-header"
      className="h-14 bg-[#050b1d]/90 backdrop-blur-md border-b border-[#142654] sticky top-0 z-30 flex items-center justify-between pl-14 pr-4 lg:px-6 gap-4 font-sans select-none"
    >
